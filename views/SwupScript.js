...
const swup = new Swup();
function init() {
  if (document.querySelector(".adrian-hero-shot")) {
   ...
   document.querySelector(".year").innerHTML= currentTime.getFullYear();
    ...
    /////////////////end of scroll and modal code.
    }
   else if (!document.querySelector(".adrian-hero-shot")) {
    console.log("we are in another html");
  }
}
